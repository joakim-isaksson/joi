...
{
	[CreateAssetMenu(menuName = "Joi/Variables/GameObject")]
	public class VariableGameObject : ScriptableObject, IVariable<GameObject>, ISerializationCallbackReceiver
	{
#if UNITY_EDITOR
		...
		public static implicit operator GameObject(VariableGameObject variable)
		{
