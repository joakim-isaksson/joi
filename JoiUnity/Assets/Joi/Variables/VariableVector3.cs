...
{
	[CreateAssetMenu(menuName = "Joi/Variables/Vector3")]
	public class VariableVector3 : ScriptableObject, IVariable<Vector3>, ISerializationCallbackReceiver
	{
#if UNITY_EDITOR
		...
		public static implicit operator Vector3(VariableVector3 variable)
		{
